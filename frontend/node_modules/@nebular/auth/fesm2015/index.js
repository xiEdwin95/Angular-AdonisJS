...
NbAuthTokenParceler = __decorate$4([
    Injectable(),
    __param$1(0, Inject(NB_AUTH_FALLBACK_TOKEN)),
    __param$1(1, Inject(NB_AUTH_TOKENS)),
...
let NbOAuth2AuthStrategy = NbOAuth2AuthStrategy_1 = class NbOAuth2AuthStrategy extends NbAuthStrategy {
    ...
    addCredentialsToParams(params) {
        if (this.clientAuthMethod === NbOAuth2ClientAuthMethod.REQUEST_BODY) {
            if (this.getOption('clientId') && this.getOption('clientSecret')) {
                return Object.assign({}, params, { client_id: this.getOption('clientId'), client_secret: this.getOption('clientSecret') });
            }
            else {
...
NbPasswordAuthStrategy = NbPasswordAuthStrategy_1 = __decorate$7([
    Injectable(),
    __metadata$5("design:paramtypes", [HttpClient, ActivatedRoute])
...
NbAuthComponent = __decorate$8([
  ...
  `,
    ...
    __metadata$6("design:paramtypes", [NbAuthService, Location])
], NbAuthComponent);
...
NbLoginComponent = __decorate$10([
    ...
    __param$3(1, Inject(NB_AUTH_OPTIONS)),
    __metadata$7("design:paramtypes", [NbAuthService, Object, ChangeDetectorRef,
        Router])
], NbLoginComponent);
...
NbRegisterComponent = __decorate$11([
    ...
    __param$4(1, Inject(NB_AUTH_OPTIONS)),
    __metadata$8("design:paramtypes", [NbAuthService, Object, ChangeDetectorRef,
        Router])
], NbRegisterComponent);
...
NbLogoutComponent = __decorate$12([
    ...
    __param$5(1, Inject(NB_AUTH_OPTIONS)),
    __metadata$9("design:paramtypes", [NbAuthService, Object, Router])
], NbLogoutComponent);
...
NbRequestPasswordComponent = __decorate$13([
    ...
    __param$6(1, Inject(NB_AUTH_OPTIONS)),
    __metadata$10("design:paramtypes", [NbAuthService, Object, ChangeDetectorRef,
        Router])
...
NbResetPasswordComponent = __decorate$14([
    ...
    __param$7(1, Inject(NB_AUTH_OPTIONS)),
    __metadata$11("design:paramtypes", [NbAuthService, Object, ChangeDetectorRef,
        Router])
...
NbAuthJWTInterceptor = __decorate$15([
    Injectable(),
    __param$8(1, Inject(NB_AUTH_TOKEN_INTERCEPTOR_FILTER)),
    __metadata$12("design:paramtypes", [Injector, Object])
...
NbAuthSimpleInterceptor = __decorate$16([
    Injectable(),
    __param$9(1, Inject(NB_AUTH_INTERCEPTOR_HEADER)),
    __metadata$13("design:paramtypes", [Injector, String])
